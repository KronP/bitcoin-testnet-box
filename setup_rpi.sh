...
wget "https://bitcoincore.org/bin/bitcoin-core-${BITCOIN_CORE_VERSION}/bitcoin-${BITCOIN_CORE_VERSION}-arm-linux-gnueabihf.tar.gz"
tar xzf "bitcoin-${BITCOIN_CORE_VERSION}-arm-linux-gnueabihf.tar.gz"
